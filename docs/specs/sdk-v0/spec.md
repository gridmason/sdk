...
Generated by the spec-to-issues run (gridmason/sdk). Epics carry `type:epic`; Phase A subs are `status:ready`, Phase B subs are `status:blocked` (milestone-gated until Phase A exit, SCOPE guardrail 1).

| Epic | Issue | Sub-issues |
|---|---|---|
| S-E0 Bootstrap (Phase A) | [#1](../../../../issues/1) | [#2](../../../../issues/2) scaffold + CI + changesets + community files (ready) · [#3](../../../../issues/3) type-level integration with `@gridmason/protocol` (ready) |
| S-E1 Interface + dev implementations (Phase A) | [#4](../../../../issues/4) | [#5](../../../../issues/5) `HostSDK` interface + error surface (ready) · [#6](../../../../issues/6) `createNoopSDK()` (ready) · [#7](../../../../issues/7) `createFixtureSDK()` + schema (ready) · [#8](../../../../issues/8) React helper subset (ready) |
| S-E2 Helpers + conformance (Phase B) | [#9](../../../../issues/9) | [#10](../../../../issues/10) Vue + vanilla adapters (blocked) · [#11](../../../../issues/11) settings-form helper (blocked) · [#12](../../../../issues/12) conformance suite (blocked) · [#13](../../../../issues/13) unmount hardening (blocked) |
| S-E3 Identity binding (Phase B — with dashboard D-E4) | [#14](../../../../issues/14) | [#15](../../../../issues/15) per-instance token contract (blocked) · [#16](../../../../issues/16) `events:<ns>` gating (blocked) · [#17](../../../../issues/17) telemetry attribution (blocked) |

Milestones: **M-A** = S-E0 + S-E1 (dashboard M1 + `gridmason dev` unblocked); **M-B** = S-E2 + S-E3 (conformance suite green on the dashboard's reference host).
